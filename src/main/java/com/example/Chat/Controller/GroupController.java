...
import com.example.Chat.Entity.Vo.JoinGroupVo;
...
public class GroupController {
    ...
    public ApiResponse<String> updateGroupInfo(@RequestBody Group group) {
        boolean updateById = groupService.updateById(group);
        return updateById ? ApiResponse.ok("修改成功") : ApiResponse.fail("修改失败");
    }
